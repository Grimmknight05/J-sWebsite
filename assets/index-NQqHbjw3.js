(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(){Array.from(document.querySelectorAll(`img`)).forEach(e=>{try{e.draggable=!1,e.setAttribute(`draggable`,`false`),e.style.userSelect=`none`;try{e.style.setProperty(`-webkit-user-select`,`none`)}catch{}try{e.style.setProperty(`-ms-user-select`,`none`)}catch{}e.addEventListener(`contextmenu`,e=>e.preventDefault()),e.addEventListener(`dragstart`,e=>e.preventDefault())}catch{}});let e=document.createElement(`style`);e.setAttribute(`data-generated-by`,`protections`),e.appendChild(document.createTextNode(`
  ...
  `)),document.head?.appendChild(e),document.addEventListener(`copy`,e=>{let t=document.getSelection();if(t)for(let n=0;n<t.rangeCount;n++){let r=t.getRangeAt(n);Array.from(r.cloneContents().querySelectorAll?.(`img`)??[]).length>0&&e.preventDefault()}})}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,e):e();var t=`modulepreload`,n=function(e,t){return new URL(e,t).href},r={};document.body.dataset.page?function(e,i,a){let o=Promise.resolve();if(i&&i.length>0){let e=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function u(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}o=l(i.map(i=>{if(i=n(i,a),i=u(i),i in r)return;r[i]=!0;let o=i.endsWith(`.css`);for(let t=e.length-1;t>=0;t--){let n=e[t];if(n.href===i&&(!o||n.rel===`stylesheet`))return}let s=document.createElement(`link`);if(s.rel=o?`stylesheet`:t,o||(s.as=`script`),s.crossOrigin=``,s.href=i,c&&s.setAttribute(`nonce`,c),document.head.appendChild(s),o)return new Promise((e,t)=>{s.addEventListener(`load`,e),s.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${i}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(t=>{for(let e of t||[])e.status===`rejected`&&s(e.reason);return e().catch(s)})}(()=>import(`./subject-page-BQZPmVSs.js`),[],import.meta.url):document.querySelector(`#app`).innerHTML=`
  <div class="page">
    <header class="topbar">
